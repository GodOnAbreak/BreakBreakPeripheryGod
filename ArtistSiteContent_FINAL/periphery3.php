...
<div class="navbar">
    <span class="site-title">p e r i p h e r y   </span> |
...
<div class="page">
    ...
    <div class="main">
        ...
        <div class="album">
            <div class="cover">
                <img src="images/Periphery_3.png" alt="Periphery III">
            </div>
            <div>
                <h3>Periphery III</h3>
                <p>2016</p>
                <a class="btn" href="absolomb.php">Listen</a>
        ...
        <div class="album">
            <div class="cover">
                <img src="images/Periphery_4.jpg" alt="Periphery IV">
            </div>
            <div>
                <h3>Periphery IV</h3>
                <p>2019</p>
        ...
        <div class="album">
            <div class="cover">
                <img src="images/Periphery_6.jpg" alt="A Pale White Dot">
            </div>
            <div>
                <h3>A Pale White Dot</h3>
                <p>2026</p>
                <a class="btn" href="pale.php">Listen</a>
                <a class="btn" href="#">Store</a>
            </div>
        </div>
